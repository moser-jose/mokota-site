            ...
            <div className="container faq-1">
                <div className="grid-1-3 first">
                    ...
                    explicaremos ao fundo todas as ferramentas que utilizaremos, sem omitir.
                        Então, esse curso é para todos os que até o momento não pegaram o jeito em programação. </p>
                </div>
                <div className="grid-1-3">
                    <h2>Eu já sou programador, devo fazer esse curso?</h2>
                    <p><span>SIM!</span> Isso irá facilitar o aluno no aprendizado do framework e manter a lógica para os aplicativos
                    que iremos desenvolver. E de certa forma ajudará o professor a transmitir o conhecimento
                        de forma equilibrada aos demais alunos que estão a começar agora no mundo da programação. </p>
                </div>
                <div className="grid-1-3">
                    <h2>Quanto tempo dura o curso?</h2>
                    <p>O curso sendo presencial, <span>oficialmente dura 1 mês</span>, no entanto, se o aluno preferir, pode
